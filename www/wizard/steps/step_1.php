...
$text_descr = _("
اینترفیس شبکه در AlienVault OSSIM  را برای اجرای نظارت بر شبکه یا به عنوان جمع آوری و اسکن لاگ ها می توان پیکربندی کرد  پس از اینکه اینترفیس ها را پیکربندی کردید، باید اطمینان حاصل کنید که شبکه به طور مناسب برای هر رابط کاربری پیکربندی شده است، به طوری که AlienVault OSSIMیا داده ها را به صورت غیرمستقیم دریافت می کند یا قادر به دسترسی به شبکه مورد نظر است .");
